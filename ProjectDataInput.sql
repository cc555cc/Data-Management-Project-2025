...
(1006, 'Leo Chang', 'leo@student.edu','hash6');
...
(3006, 1001, 2002, '2025-09-10 15:00:00', 'summary6.pdf');
...
(4006, 1006, 2001, '00:28:00', '2025-10-25 13:00:00');
...
(5016,4006,'What is normalization?','Process of organizing data','Process of organizing data',5,5),
(5017,4006,'What is a primary key?','Unique identifier','Unique identifier',5,5),
(5018,4006,'What is a foreign key?','Links tables together','Links tables together',5,4);
...
(6006, 1001, 2002, 'Database midterm', 'quiz', 'Data Management Midterm on chapter 1-3', '2025-11-20 13:00:00',75);
...
(7006,1001,'2025-11-01 12:00:00','2025-11-01 15:00:00');
...
(9006,1003,'project meeting','2025-11-09 13:00:00', '2025-11-09 15:00','meet with project group');
...
(10006,1006,'Explain NoSQL','Not only sql','2025-09-15 08:00:00');
...
(11006,1006,'StudyHours',3,'2025-11-05 14:00:00');
